...
function* getBountyStatisticWorker(action) {
  try {
    ...
    const data = yield call(() => {
        return fetch('http://lk/admin/getBountyStatistic.php', {
          method:'GET',
        })
              .then(res => res.json())
        }
...
function* getTransactionListWorker(action) {
  try {
    ...
    const data = yield call(() => {
        return fetch('http://lk/admin/getTransactionList.php', {
          method:'GET',
        })
              .then(res => res.json())
        }
...
function* getUsersRegisterWorker(action) {
  try {
    ...
    const data = yield call(() => {
        return fetch('http://lk/admin/getUsersRegister.php', {
          method:'POST',
          body:action.payload
        })
              .then(res => res.json())
...
function* addAdminWorker(action) {
  try {
    const data = yield call(() => {
        return fetch('http://lk/admin/addAdmin.php', {
          method:'POST',
          body:action.payload
        })
              .then(res => res.json())
...
function* toggleAdminWorker(action) {
  try {
    ...
    const data = yield call(() => {
        return fetch('http://lk/admin/toggleAdmin.php', {
          method:'POST',
          body:action.payload
        })
              .then(res => res.json())
...
function* getAdminsWorker(action) {
  try {
    const data = yield call(() => {
        return fetch('http://lk/admin/getAdmins.php', {
          method:'GET',
        })
              .then(res => res.json())
        }
