...
function* airDropSettingsToggleWorker(action) {
  try {
    const data = yield call(() => {
        return fetch('http://lk/airdrop/airDropSettingsToggle.php', {
          method:'POST',
          body: action.payload
        })
              .then(res => res.json())
...
function* airDropGetRatesWorker(action) {
  try {
    ...
    const data = yield call(() => {
        return fetch('http://lk/airdrop/airDropGetRates.php', {
          method:'GET',
        })
              .then(res => res.json())
        }
...
function* submitAirDropTypeWorker(action) {
  try {
    const data = yield call(() => {
        return fetch('http://lk/airdrop/submitAirDropType.php', {
          method:'POST',
          body: action.payload
        })
              .then(res => res.json())
...
function* userSubmitAirdropWorker(action) {
  try {
    const data = yield call(() => {
        return fetch('http://lk/airdrop/userSubmitAirdrop.php', {
          method:'POST',
          body: action.payload
        })
              .then(res => res.json())
...
function* getAirdropForCheckAdminWorker(action) {
  try {
    ...
    const data = yield call(() => {
        return fetch('http://lk/admin/getAirdropForCheckAdmin.php', {
          method:'POST',
          body:action.payload
        })
              .then(res => res.json())
...
function* saveAirDropCheckWorker(action) {
  try {
    const data = yield call(() => {
        return fetch('http://lk/admin/saveAirDropCheck.php', {
          method:'POST',
          body:action.payload
        })
              .then(res => res.text())
...
function* getAirdropStatisticWorker(action) {
  try {
    const data = yield call(() => {
        return fetch('http://lk/admin/getAirdropStatistic.php', {
          method:'POST',
          body:action.payload
        })
              .then(res => res.json())
