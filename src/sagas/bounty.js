...
function* getBountyForCheckAdminWorker(action) {
  try {
    const data = yield call(() => {
        return fetch('http://lk/admin/getBountyForCheck.php', {
          method:'POST',
          body:action.payload
        })
              .then(res => res.json())
...
function* saveBountyListCheckWorker(action) {
  try {
    const data = yield call(() => {
        return fetch('http://lk/admin/sendBountyListChecked.php', {
          method:'POST',
          body:action.payload
        })
              .then(res => res.json())
...
function* changeSettingsWorker(action) {
  try {
    const data = yield call(() => {
        return fetch('http://lk/admin/changeSettingsBounty.php', {
          method:'POST',
          body:action.payload
        })
              .then(res => res.json())
...
function* getBountySettingsWorker(action) {
  try {
    const data = yield call(() => {
        return fetch('http://lk/admin/getBountySettings.php', {
          method:'GET',
